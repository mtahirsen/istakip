<?php
$data = $core->get_row(Module_Table,"*","WHERE id='".$online_admin["id"]."'");
?>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			<div class="row">
				...
				<div class="pull-right col-xs-12 col-sm-auto"><a href="?s=display&dispatch=<?=Module_Link?>.list" class="btn btn-primary btn-labeled" style="width: 100%;"><span class="btn-label icon fa fa-plus"></span>Listeye Dön</a></div>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="panel">
			<div class="panel-heading">
				<span class="panel-title">Bilgilerimi Düzenle</span>
			</div>
			<div class="panel-body">
				<?php include(Module_Folder."/process/my_profile_edit.php"); ?>
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							...
							<a href="?s=display&dispatch=<?=Module_Link?>.edit&page=&id=3&delete_image=1" class="btn btn-danger dialog-link">Resimi Sil</a>
							<?php } ?>
						</div>
					</div>
					<div class="form-group">
