...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error']                  = 'Dosya Yüklenemedi, Lütfen tekrar deneyin.';
        $this->translation['local_file_missing']          = 'Dosya bulunamadı. Lütfen tekrar deneyin.';
        $this->translation['local_file_not_readable']     = 'Dosya okunamadı.';
        $this->translation['uploaded_too_big_ini']        = 'Hata oluştu (Eklemek istediğiniz dosyanın boyutu çok yüksek. php.ini buna izin vermiyor. php.ini üzerinden upload_max_filesize deðerini yükselterek tekrar deneyebilirsiniz.).';
        $this->translation['uploaded_too_big_html']       = 'Hata oluştu (Yüksek boyutlu bir dosya yüklemeye çalıştınız.).';
        ...
        $this->translation['uploaded_no_tmp_dir']         = 'Hata oluştu (missing a temporary folder).';
        $this->translation['uploaded_cant_write']         = 'Hata oluştu (failed to write file to disk).';
        $this->translation['uploaded_err_extension']      = 'Hata oluştu (file upload stopped by extension).';
        $this->translation['uploaded_unknown']            = 'Hata oluştu (unknown error code).';
        $this->translation['try_again']                   = 'Hata oluştu. Please try again.';
        $this->translation['file_too_big']                = 'Dosya Yüklenemedi. Max: 1 MB';
